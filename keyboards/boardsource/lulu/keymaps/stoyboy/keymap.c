 ...
 * MSWAP = swap Cmd/Ctrl (CG_TOGG, for Mac/Win switching)
 * TMAC  = toggle Mac media layer
 */
  [_SYM] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX,  KC_DLR, KC_PERC, KC_CIRC, 	KC_EQL,                   XXXXXXX, KC_LCBR, KC_RCBR, XXXXXXX, XXXXXXX, TG(_MAC),
...
/* MAC - Media controls for macOS
 * Toggle this layer via TMAC in the SYM layer.
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |      |      |      |                    |      | Prev |Play/ | Next |      |      |
 ...
 *                   `----------------------------'           '------''--------------------'
 *
 * Right hand home row (HJKL;):  Mute | VolD | VolU | BriD | BriU
 * Right hand top row  (YUIOP):       | Prev | Play | Next |
 */
  [_MAC] = LAYOUT(
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_MUTE, KC_VOLD, KC_VOLU, KC_BRID, KC_BRIU, XXXXXXX,
